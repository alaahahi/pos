    ...
    <div class="pagetitle dark:text-white">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <Link class="nav-link dark:text-white" :href="route('products.index')">
              {{ translations.products }}
            </Link>
          </li>
          <li class="breadcrumb-item active dark:text-white">{{ translations.create }}</li>
        </ol>
      </nav>
    </div>
    <!-- End Breadcrumb -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              ...
              <p class="text-muted mb-0">{{ translations.add_new_product_description }}</p>
            </div>
            <div class="card-body">
              <!-- Progress Steps -->
              <div class="row mb-4">
              ...
              <form @submit.prevent="store" class="needs-validation" novalidate>
                ...
                <div class="form-section" v-show="currentStep >= 4">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <div class="image-upload-area" @click="triggerFileInput" :class="{ 'has-image': imagePreview }">
                        <input
                          ref="fileInput"
                          id="inputImage"
                          type="file"
                        ...
                        <div v-else class="image-preview">
                          <img :src="imagePreview" :alt="translations.product_image" />
