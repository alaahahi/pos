          ...
          <form @submit.prevent="submitOrder">
            ...
            <div class="row mb-4">
              ...
              <div class="col-md-8">
                ...
                <select class="form-select" v-model="form.customer_id" @change="onCustomerSelect">
            ...
            <div class="row mb-4">
              ...
              <div class="col-md-6">
                ...
                <input  class="form-control" type="text" v-model="form.event_address" required> 
              </div>
              <div class="col-md-3">
                <label class="form-label">{{ translations.event_date }} *</label>
                <input type="date" class="form-control" v-model="form.event_date" required>
              </div>
              <div class="col-md-3">
                <label class="form-label">{{ translations.event_time }} *</label>
                <input type="time" class="form-control" v-model="form.event_time" required>
              </div>
              <div class="col-md-6 mt-3">
                <label class="form-label">{{ translations.guest_count }}</label>
                <input type="number" class="form-control" v-model="form.guest_count" min="1">
              </div>
              <div class="col-md-6 mt-3">
                <label class="form-label">{{ translations.special_requests }}</label>
                <input  class="form-control" type="text"  v-model="form.special_requests"> 
              </div>
            </div>
