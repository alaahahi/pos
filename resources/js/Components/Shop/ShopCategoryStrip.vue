  ...
  <div class="space-y-3">
    ...
    >
      <button
        ...
        class="group shop-category-tab flex w-[7.5rem] shrink-0 snap-start flex-col overflow-hidden rounded-2xl border-2 text-right transition duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-shop-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-950"
      ...
      >
        ...
        <div class="p-2.5">
          <p class="shop-category-tab__title truncate text-sm font-semibold">
            {{ cat.name }}
          </p>
          <p class="shop-category-tab__count text-xs">{{ cat.active_products_count ?? 0 }} منتج</p>
        </div>
      </button>
    </div>
