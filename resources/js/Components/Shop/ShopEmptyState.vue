<template>
  <div class="flex flex-col items-center justify-center rounded-xl border border-dashed border-slate-200 bg-white px-6 py-16 text-center animate-shop-fade-in">
    <div
...
<script setup>
defineProps({
  title: { type: String, default: 'لا توجد عناصر' },
  description: String,
