@php
    ...
    $texts = [
        'title' => $isArabic ? 'تقرير المصاريف' : 'EXPENSES REPORT',
        ...
        'total_count' => $isArabic ? 'عدد السجلات:' : 'TOTAL RECORDS:',
    ...
    <div class="report-container">
        ...
        <div class="report-content">
            ...
            <div class="statistics-section">
                <div class="section-title">{{ $isArabic ? 'إحصائيات المصاريف' : 'EXPENSES STATISTICS' }}</div>
            ...
            <table class="items-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 35%;" class="text-left">{{ $texts['description'] }}</th>
                        <th style="width: 20%;">{{ $texts['category'] }}</th>
                        <th style="width: 15%;">{{ $texts['amount'] }}</th>
                        <th style="width: 10%;">{{ $texts['currency'] }}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $expense->category ?? ($isArabic ? 'غير محدد' : 'N/A') }}</td>
