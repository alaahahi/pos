@php
    ...
    $texts = [
        'title' => $isArabic ? 'تقرير الإغلاق اليومي' : 'DAILY CLOSES REPORT',
    ...
    <div class="report-container">
        ...
        <div class="report-content">
            ...
            <div class="statistics-section">
                <div class="section-title">{{ $isArabic ? 'إحصائيات الإغلاق اليومي' : 'DAILY CLOSES STATISTICS' }}</div>
            ...
            <table class="items-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 8%;">{{ $texts['date'] }}</th>
                ...
                <tbody>
                    @foreach($daily_closes as $index => $close)
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>{{ \Carbon\Carbon::parse($close->close_date)->format('d/m/Y') }}</td>
