    ...
    <div class="report-container">
        ...
        <div class="report-content">
            ...
            <div class="statistics-section">
                <div class="section-title">{{ $isArabic ? 'إحصائيات المشتريات' : 'PURCHASES STATISTICS' }}</div>
            ...
            <table class="items-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 20%;">{{ $texts['date'] }}</th>
                        <th style="width: 45%;" class="text-left">{{ $texts['supplier'] }}</th>
                        <th style="width: 30%;">{{ $texts['amount'] }}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-left">{{ $purchase->supplier->name ?? 'N/A' }}</td>
